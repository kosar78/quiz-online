...
$(document).ready(function () {
  axios.get('http://localhost:3000/api/v1/course/ListOfProffCourses', {
    ...
    $("#save-step1-info").click(function () {
      var test_title = document.querySelector('#test-title').value;
      var course_name = document.querySelector('#courses').value;
      var start_test_time = document.querySelector('#start-test-time').value;
      var end_test_time = document.querySelector('#end-test-time').value;
      var quizTime = document.querySelector('#test-time').value;
      var q_num = document.querySelector('#test-q-num').value;
      var CourseId;
      ...
      if (course_name == "انتخاب کنید") {
        ...
        for (var _i = 0; _i < coursesList.length; _i++) {
          if (coursesList[_i].name == course_name) {
            CourseId = coursesList[_i].id;
          }
        }
      }
