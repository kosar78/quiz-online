    ...
    .then(res =>{
        ...
        .then(res =>{
            ...
            for(let d=0;course_array.length;d++){
                ...
                let course_uni_id=course_array[d].uniId
                ...
                for(let c=0;c<j;c++){
                    for(let b=0;b<course_students_id.length;b++){
                        if(student_array[c].id==course_students_id[b]){
                            course_students_array=studentIds_array[c]
                        }
                    }
                ...
                var td3_text = document.createTextNode(teacher_fullName);         // Create a text node
