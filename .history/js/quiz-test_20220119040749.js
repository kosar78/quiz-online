...
$(document).ready(function(){
    ...
    .then(res =>{
        ...
        $("#end-quiz-btn").click(function(){
            ...
            axios.put(link,{
                headers: {
                    'Authorization' : `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfdHlwZSI6InVzZXIiLCJzdWJqZWN0IjozLCJpYXQiOjE2NDI1NTE3MzB9.EnkEARHbASYvIAx7cb2t1x9SOjywa6p25CNFUBLpsDc`
                }
            })
            .then(res =>{
                console.log(res.data)
