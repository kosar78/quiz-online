    ...
    .then(res =>{
        ...
        if(teacherTestsArray.lenght==0){
                    ...
                    for(let i=0;i<teacherTestsArray.lenght;i=i+1){
                        ...
                        var td2_text = document.createTextNode(teacherTestsArray[i].username);
                        var td3_text = document.createTextNode(teacherTestsArray[i].fullName);         // Create a text node
                    ...
                    $(document).ready(function(){
                        $(".delete-from-list").click(function(){
                            ...
                            axios.delete('http://localhost:3000/api/v1/user/deleteUser/'+teacherId,{
                        ...
                        $(".edit-teacher").click(function(){
                            ...
                            for(let g=0;g<userlist_lenght;g++){
                                if(teacher_array[g].email==tEmail){
                                    console.log(teacher_array[g].id)
                                    teacherId=teacher_array[g].id
                                    localStorage.toggled=token+"|"+teacherId

                                    break
                                }

                            }
                            window.location.href="manager-panel-teacher-edit.html"
                        })
