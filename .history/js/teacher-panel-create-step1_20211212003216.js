    ...
    .then(res =>{
        ...
        $("#save-step1-info").click(function(){
            ...
            if($("#type1 .circle-2").hasClass("choosed")){
                ...
                numOfEnter=document.querySelector('#duration-time-type3').value
                questionTime=document.querySelector('#q-time-t3').value
                arrange_Q=document.querySelector('#arrange_Q-t3').value
                ...
                QtoQFullTime=true
                numOfEnter=document.querySelector('#duration-time-type4').value
                duration=document.querySelector('#test-time-t4').value
                ...
                // arrange_Q=document.querySelector('#arrange_Q-t4').value
                backtoQuestion=document.querySelector('#backtoQuestion').value
