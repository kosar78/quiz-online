$(document).ready(function(){
    ...
    .then(res =>{
        ...
        if(teacherTestsArray.length==0){
                    document.getElementById("empty-list").innerHTML = "لیست آزمون ها خالی است";
                }
                else{
                    console.log(teacherTestsArray.length);
                    for(let i=0;i<teacherTestsArray.length;i=i+1){
                        ...
                        img3.className="test-managment-icon"
                        ...
                        img3.src="images/test-managment.svg"
