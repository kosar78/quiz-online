        ...
        $(".final-registion").click(function(){
            ...
            for(var i=1;i<=c;i++){
                ...
                for(var j=1;j<=count;j++){
                    ...
                    quesoptions[q]=$(".new-q"+i).children(".typing-q").children(".option-input"+i).text()
                    q++
                }
                // for(var z=1;z<=count;z++){
                    if($(".new-q"+i).children(".q-options").children("q-option"+i).hasClass("clicked-on-answer")){
                        answoptions[a]=$(".new-q"+i).children(".q-options").children("q-option"+i).hasClass("clicked-on-answer").text()
