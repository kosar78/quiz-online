$(document).ready(function(){
    ...
    $(".add-new-q").click(function(){
        ...
        $(".add-new-option-btn"+c).click(function(){
            ...
            $("new-q"+c+" .q-options .q-option").click(function(){
                $("new-q"+c+" .q-options .q-option").removeClass("clicked-on-answer")
        ...
        $(".final-registion").click(function(){
            ...
            for(var i=1;i<=c;i++){
                ...
                var ResponseTime=0
                var Score=0
                var face=$(".typing-q-textarea"+i).text()
                var desc=$(".typing-a-textarea"+i).text()
                var count = $(".new-q"+i).children(".q-options").children().length;
                
                for(var j=1;j<=count;j++){
                    
                    quesoptions[q]=$(".new-q"+i).children(".typing-q").children(".option-input"+j).text()
                    q++
                }
                for(var z=1;z<=count;z++){
                    if($(".new-q"+i).children(".q-options").children("q-option"+z).hasClass("clicked-on-answer")){
                        answoptions[a]=z
