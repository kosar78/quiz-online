            ...
            .then(res =>{
                ...
                if(userlist_lenght==0){
                    ...
                    for(let i=0;i<userlist_lenght;i=i+1){
                        ...
                        // var td5_text = document.createElement('<ul class="edit-delete"><li><img class="delete-teacher" src="/images/delete-icon.svg" alt=""></li><li><a href="manager-panel-addteacher.html"><img class="edit-teacher" src="images/edit-icon.svg" alt=""></a></li></ul>');
