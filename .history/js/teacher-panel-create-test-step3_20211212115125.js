    ...
    $("#final-registion").click(function(){
        ...
        for(var i=0;i<c;i++){
            ...
            for(var j=1;j<=count;j++){
                ...
                quesoptions[q]=$(".new-q"+i).children(".typing-q").children(".option-input"+j).val()
                q++
            }
            var console_check=$(".new-q"+i).children(".q-options").children(".q-option"+i).hasClass("clicked-on-answer")
