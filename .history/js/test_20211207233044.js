                ...
                if(studentIds_array.length==0){
                    ...
                    for(let i=0;i<studentIds_array.length;i++){
                        ...
                        .then(res =>{
                            ...
                            var td1_text = document.createTextNode(i+1);
                            var td2_text = document.createTextNode(studentIds_array[i].fullName);
                            var td3_text = document.createTextNode(studentIds_array[i].username);
                            var td4_text = document.createTextNode(studentIds_array[i].email);
                            ...
                            document.getElementById("list-student").remove();
                        })
