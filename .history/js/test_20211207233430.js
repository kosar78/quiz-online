                ...
                if(studentIds_array.length==0){
                    ...
                    for(let a=0;a<studentIds_array.length;a++){
                        ...
                        .then(res =>{
                            ...
                            var td1_text = document.createTextNode(i+1);
                            var td2_text = document.createTextNode(studentIds_array[a].fullName);
                            var td3_text = document.createTextNode(studentIds_array[a].username);
                            var td4_text = document.createTextNode(studentIds_array[a].email);
